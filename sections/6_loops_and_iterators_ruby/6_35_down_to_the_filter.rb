...
odds = numbers.select { |n| n.odd? } # select has ! dangerous method
evens = numbers.reject { |n| n.odd? } # reject too
...
# methods alias
p 'f'
puts (1..30).find { |n| n % 7 == 0}
p 'd'
puts (1..30).detect { |n| n % 7 == 0}
p 's'
puts (1..30).select { |n| n % 7 == 0}
